...
class ptQrCodePage extends StatefulWidget {
  ptQrCodePage(this.filepath, this.dval);

  late final String filepath;
  late final String dval;

  @override
  State<ptQrCodePage> createState() => _ptQrCodePageState();
}

class _ptQrCodePageState extends State<ptQrCodePage> {
